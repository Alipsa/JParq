...
- **Javadoc is required** on all public/protected classes and methods. Include descriptions, `@param`, `@return`, and `@throws` as appropriate. Checkstyle enforces this strictly.
