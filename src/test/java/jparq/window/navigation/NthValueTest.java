...
/**
 * Integration tests covering the SQL standard NTH_VALUE window navigation function.
 */
public class NthValueTest {
  ...
  /**
   * Verify that NTH_VALUE can denormalize the second highest horsepower per cylinder partition.
   */
  @Test
  ...
  /**
   * Verify that a ROWS CURRENT ROW frame yields null when the frame is smaller than the requested N.
   */
  @Test
  ...
  /**
   * Ensure that the default RANGE frame (UNBOUNDED PRECEDING TO CURRENT ROW) grows as rows are processed.
   */
  @Test
