...
public final class StringFunctions {
  ...
  private static final Map<String, String> CHARSET_ALIASES = Map.ofEntries(
      Map.entry("UTF8", StandardCharsets.UTF_8.name()), Map.entry("UTF-8", StandardCharsets.UTF_8.name()),
      Map.entry("UTF8MB4", StandardCharsets.UTF_8.name()), Map.entry("UCS2", "UTF-16BE"),
      Map.entry("UTF-16BE", "UTF-16BE"), Map.entry("UTF16", "UTF-16"), Map.entry("UTF-16", "UTF-16"),
      Map.entry("LATIN1", "ISO-8859-1"), Map.entry("ISO-8859-1", "ISO-8859-1"), Map.entry("ASCII", "US-ASCII"),
      Map.entry("US-ASCII", "US-ASCII"), Map.entry("LATIN2", "ISO-8859-2"), Map.entry("ISO-8859-2", "ISO-8859-2"),
      Map.entry("EUC-JP", "EUC-JP"), Map.entry("UJIS", "EUC-JP"), Map.entry("SJIS", "Shift_JIS"),
      Map.entry("CP932", "Shift_JIS"), Map.entry("GBK", "GBK"), Map.entry("GB2312", "GB2312"),
      Map.entry("KOI8-R", "KOI8-R"), Map.entry("KOI8_R", "KOI8-R"), Map.entry("WINDOWS-1252", "Windows-1252"),
   ...
   * Supports SQL wildcards {@code %} (matches any sequence of characters) and
   * {@code _} (matches any single character), as well as an optional escape
   * character to treat wildcards as literals.
   *
   * @param pattern
   *          the SQL LIKE pattern to convert
   * @param escape
   *          optional escape character (may be {@code null}); if present, the
   *          next character is treated as a literal
   * @return the equivalent Java regular expression string
   * @throws IllegalArgumentException
   *           if the escape character appears at the end of the pattern
   */
