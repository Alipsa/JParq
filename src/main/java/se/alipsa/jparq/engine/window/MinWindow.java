...
/**
 * Representation of a MIN analytic expression.
 */
public final class MinWindow {
  ...
  MinWindow(AnalyticExpression expression, List<Expression> partitionExpressions, List<OrderByElement> orderByElements,
  ...
  /**
   * Retrieve the argument expression evaluated by the MIN function.
   *
  ...
  /**
   * Retrieve the window frame specification associated with this MIN window.
   *
