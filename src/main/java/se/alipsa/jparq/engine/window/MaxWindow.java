...
/**
 * Representation of a MAX analytic expression.
 */
public final class MaxWindow {
  ...
  /**
   * Retrieve the argument expression evaluated by the MAX function.
   *
  ...
  /**
   * Retrieve the window frame specification associated with this MAX window.
   *
