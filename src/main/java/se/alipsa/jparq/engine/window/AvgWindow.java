...
/**
 * Representation of an AVG analytic expression.
 */
public final class AvgWindow {
  ...
  AvgWindow(AnalyticExpression expression, List<Expression> partitionExpressions, List<OrderByElement> orderByElements,
  ...
  /**
   * Retrieve the argument expression evaluated by the AVG function.
   *
  ...
  /**
   * Retrieve the window frame specification associated with this AVG window.
   *
