...
/**
 * Representation of a FIRST_VALUE analytic expression.
 */
public final class FirstValueWindow {
   ...
   *          the expression evaluated by the FIRST_VALUE function
   * @param windowElement
   *          the window frame specification requested by the analytic expression
   */
  public FirstValueWindow(AnalyticExpression expression, List<Expression> partitionExpressions,
