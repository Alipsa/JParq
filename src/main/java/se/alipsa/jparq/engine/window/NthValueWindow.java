...
public final class NthValueWindow {
  ...
  /**
   * Retrieve the expression that resolves the requested position within the frame.
   *
  ...
  /**
   * Retrieve the window frame specification associated with this NTH_VALUE window.
   *
