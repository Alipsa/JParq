...
/**
 * Representation of a LEAD analytic expression.
 */
public final class LeadWindow {
  ...
  LeadWindow(AnalyticExpression expression, List<Expression> partitionExpressions, List<OrderByElement> orderByElements,
  ...
  /**
   * Retrieve the value expression evaluated by the LEAD function.
   *
   * @return the expression supplying the value to retrieve from following rows
   */
  ...
  /**
   * Retrieve the offset expression evaluated by the LEAD function.
   *
   * @return the expression describing how many rows to look ahead (may be
   *         {@code null})
   */
